...
const DisButton = () => {
  return (
      <div className="relative inline-flex items-center justify-center gap-4 group cursor-pointer">
        ...
        <div className="group bg-[#7F96FF] relative inline-flex items-center justify-center text-base rounded-xl px-8 py-3 font-semibold text-white transition-all duration-200 hover:bg-[#7F96FF] hover:shadow-lg hover:-translate-y-0.5 hover:shadow-gray-600/30">
          Join Our Discord<svg aria-hidden="true" viewBox="0 0 10 10" height={10} width={10} fill="none" className="mt-0.5 ml-2 -mr-1 stroke-white stroke-2">
