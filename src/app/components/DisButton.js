  ...
  return (
      <Link href={"https://discord.gg/JTtaH6Bd"} target={"_blank"}>
        <div className="relative inline-flex items-center justify-center gap-4 group cursor-pointer">
          ...
          <div
              className="group bg-[#7F96FF] relative inline-flex items-center justify-center text-base rounded-xl px-8 py-3 font-semibold text-white transition-all duration-200 hover:bg-[#7F96FF] hover:shadow-lg hover:-translate-y-0.5 hover:shadow-gray-600/30">
            Join Our Discord
